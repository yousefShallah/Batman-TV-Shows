  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Blog, [{
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        {
          console.log('test test', show.show.name);
        }
      })), __jsx("ul", {
        __source: {
          fileName: _jsxFileName,
        ...
        __self: this
      }, this.state.shows.map(function (showPost) {
        __jsx("li", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 37
          ...
          __self: this
        }, " ", _this2.showPost.show.id, " "));

        {
          console.log('test id', showPost.show.id);
        }
      })));
    }
  }]);
...
//# sourceMappingURL=index.js.fcbdc47df51670cc1ed5.hot-update.js.map